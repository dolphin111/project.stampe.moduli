 ...
 * Time: 15.23
 */
public class ScadenzaRamo3_C {
    public static String getXml(){

        String s="<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\n" +
                "<polizza>\n" +
                "    <dataElaborazione>2013-09-11</dataElaborazione>\n" +
                "    <datiTecnici>\n" +
                "        <numeroPolizza>7598821</numeroPolizza>\n" +
                "        <codiceConferimento>15425038005</codiceConferimento>\n" +
                "        <stato>Attiva</stato>\n" +
                "        <sottostato>ATTIVA</sottostato>\n" +
                "        <prodotto>\n" +
                "            <codice>38004</codice>\n" +
                "            <descrizione>Financial Age Pension</descrizione>\n" +
                "        </prodotto>\n" +
                "        <tariffa>\n" +
                "            <codice>970</codice>\n" +
                "            <descrizione>Rendita vitalizia differita con controassicurazione a premio ricorrente di tipo Unit Linked</descrizione>\n" +
                "        </tariffa>\n" +
                "        <ramoMinisteriale>3</ramoMinisteriale>\n" +
                "        <tipoPrestazione>R</tipoPrestazione>\n" +
                "        <tipoPolizza>A</tipoPolizza>\n" +
                "        <dataEmissione>2002-10-30</dataEmissione>\n" +
                "        <dataScadenza>2013-09-17</dataScadenza>\n" +
                "        <reteVendita>BFI</reteVendita>\n" +
                "    </datiTecnici>\n" +
                "    <figureContrattuali>\n" +
                "        <contraente>\n" +
                "            <personaFisica>\n" +
                "                <cognome>RUGGERI</cognome>\n" +
                "                <nome>PAOLO</nome>\n" +
                "                <codicefiscale>RGGPLA53P17L191B</codicefiscale>\n" +
                "                <datanascita>1953-09-17</datanascita>\n" +
                "                <sesso>M</sesso>\n" +
                "                <vip>false</vip>\n" +
                "            </personaFisica>\n" +
                "        </contraente>\n" +
                ...
                "            <indirizzo>VLE BENADDUCI 14</indirizzo>\n" +
                "            <cap>62029</cap>\n" +
                "            <comune>TOLENTINO</comune>\n" +
                "            <provincia>MC</provincia>\n" +
                "            <regione>Marche</regione>\n" +
                ...
                "        <banker>\n" +
                "            <privateBanker>\n" +
                "                <cognome>PASQUALI</cognome>\n" +
                "                <nome>GIUSEPPE</nome>\n" +
                "                <codicefiscale>PSQGPP49T28E783K</codicefiscale>\n" +
                "                <datanascita>1949-12-28</datanascita>\n" +
                "                <sesso>M</sesso>\n" +
                "                <vip>false</vip>\n" +
                "            </privateBanker>\n" +
                "            <dataInizio>1999-07-01</dataInizio>\n" +
                "            <stato>Attivo</stato>\n" +
                ...
                "    </prestazioni>\n" +
                "    <finanziario>\n" +
                "        <quoteTotali>2146.457</quoteTotali>\n" +
                "        <controvaloreTotale>22671.040355</controvaloreTotale>\n" +
                "        <dataRiferimentoNAV>2013-09-09</dataRiferimentoNAV>\n" +
                "    </finanziario>\n" +
                "    <contabile>\n" +
                "        <totalePremiAnnuiIncassati>22000.0</totalePremiAnnuiIncassati>\n" +
                "        <totalePremiAggiuntiviOggi>0.0</totalePremiAggiuntiviOggi>\n" +
                "        <sommaPremiResiduiDaVersare>0.0</sommaPremiResiduiDaVersare>\n" +
                "        <dataFinePagamentoPremi>2013-09-17</dataFinePagamentoPremi>\n" +
                "    </contabile>\n" +
                "    <altriDati>\n" +
                "        <vincolo>\n" +
                "            <attivo>false</attivo>\n" +
                ...
                "            </caricamentoCPPR3>\n" +
                "        </caricamentiCPP>\n" +
                "        <importoPianoProgrammatoVersamenti>20000.0</importoPianoProgrammatoVersamenti>\n" +
                "        <detraibilitaFiscale>\n" +
                "            <stato>true</stato>\n" +
                "            <dataFineBeneficioFiscale>2013-09-17</dataFineBeneficioFiscale>\n" +
                "        </detraibilitaFiscale>\n" +
                ...
                "    </altriDati>\n" +
                "    <stimeScadenza>\n" +
                "        <polizzaID>7598821</polizzaID>\n" +
                "        <dataRiferimentoNav>2013-04-16</dataRiferimentoNav>\n"+
                "        <ramoMinisteriale>3</ramoMinisteriale>\n" +
                "        <renditaAnnuavitaliziaMinimaGarantita>1053.54</renditaAnnuavitaliziaMinimaGarantita>\n" +
                "        <valoreRiscattoScadenzaGarantito>21560.03</valoreRiscattoScadenzaGarantito>\n" +
                "        <ipotesiRenditaAnnuaPosticipataScadenzaCVT>1234.54</ipotesiRenditaAnnuaPosticipataScadenzaCVT>\n" +
                "        <ipotesiValoreriScattoScadenzaCVT>22528.35</ipotesiValoreriScattoScadenzaCVT>\n" +
                "        <totalerenditaFrazionataAnnualePosticipata>1234.54</totalerenditaFrazionataAnnualePosticipata>\n" +
                "        <totalerenditaFrazionataSemestralePosticipata>1226.7</totalerenditaFrazionataSemestralePosticipata>\n" +
                "        <totalerenditaFrazionataTrimestralePosticipata>1222.83</totalerenditaFrazionataTrimestralePosticipata>\n" +
                "        <totalerenditaFrazionataMensilePosticipata>1220.27</totalerenditaFrazionataMensilePosticipata>\n" +
                "        <anniCertezza1>25</anniCertezza1>\n" +
                "        <totaleRenditaCerta1AnnualePosticipata>1108.84</totaleRenditaCerta1AnnualePosticipata>\n" +
                "        <totaleRenditaCerta1SemestralePosticipata>1101.93</totaleRenditaCerta1SemestralePosticipata>\n" +
                "        <totaleRenditaCerta1TrimestralePosticipata>1098.5</totaleRenditaCerta1TrimestralePosticipata>\n" +
                "        <totaleRenditaCerta1MensilePosticipata>1096.22</totaleRenditaCerta1MensilePosticipata>\n" +
                ...
                "        <nav>0.0</nav>\n" +
                "        <dataRiferimentoNav>2013-06-10</dataRiferimentoNav>\n" +
                "        <ControValoreQuote>22740.875</ControValoreQuote>\n" +
                "        <numeroQuote>2146.457</numeroQuote>\n" +
                "        <timestamp>2013-06-17</timestamp>\n" +
                "        <dataScadenza>2013-09-17</dataScadenza>\n" +
                "        <dataCalcolo>2013-06-17</dataCalcolo>\n" +
                "        <importoNettoRiscattoTermine>17878.55</importoNettoRiscattoTermine>\n" +
