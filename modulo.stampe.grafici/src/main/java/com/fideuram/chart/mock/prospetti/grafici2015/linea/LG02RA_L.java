 ...
 * Time: 21.04
 */
public class LG02RA_L extends MockBase {
    /**
    ...
    public static Linee getMockSommavillaFvInsieme(String categoria) throws GraphException {
        ...
        //Linea linea = new Linea(new Categoria("LG02RA"));
        Linea linea = new Linea(new Categoria(categoria));
        linea.addPuntoLinea(new PuntoLinea("31/01/2014", 9.52));
        linea.addPuntoLinea(new PuntoLinea("28/02/2014", 9.63));
        linea.addPuntoLinea(new PuntoLinea("31/03/2014", 9.66));
        linea.addPuntoLinea(new PuntoLinea("30/04/2014", 9.69));
        linea.addPuntoLinea(new PuntoLinea("31/05/2014", 9.84));
        linea.addPuntoLinea(new PuntoLinea("30/06/2014", 9.90));
        linea.addPuntoLinea(new PuntoLinea("31/07/2014", 9.95));
        linea.addPuntoLinea(new PuntoLinea("31/08/2014",10.02));
        linea.addPuntoLinea(new PuntoLinea("30/09/2014", 9.97));
        linea.addPuntoLinea(new PuntoLinea("31/10/2014", 9.96));
        linea.addPuntoLinea(new PuntoLinea("30/11/2014",10.02));
        linea.addPuntoLinea(new PuntoLinea("31/12/2014", 9.94));
