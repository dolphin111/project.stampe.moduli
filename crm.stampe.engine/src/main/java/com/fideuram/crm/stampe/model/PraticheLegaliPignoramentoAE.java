...
public class PraticheLegaliPignoramentoAE {
	...
	private String contributiLordi;
	private String dataRiferimentoNav;
	private String dataAdesione;
	private String posizioneIndividuale;
	private String numeroContratto;
	private String dataRicevimentoComunicazione;
	...
	public Boolean isVincoloFUG() {
		return this.vincoloFUG;
	}

	public String getLocalitaNascitaContraente() {
		return this.localitaNascitaContraente;
	}
	...
	public String getDataNascitaContraente() {
		return this.dataNascitaContraente;
	}
	...
	public String getCodiceFiscaleContraente() {
		return this.codiceFiscaleContraente;
	}
	...
	public String getContributiLordi() {
		return this.contributiLordi;
	}

	public void setContributiLordi(String contributiLordi) {
		this.contributiLordi = contributiLordi;
	}

	public String getDataRiferimentoNav() {
		return this.dataRiferimentoNav;
	}
	...
	public String getDataAdesione() {
		return this.dataAdesione;
	}

	public void setDataAdesione(String dataAdesione) {
		this.dataAdesione = dataAdesione;
	}

	public String getPosizioneIndividuale() {
		return this.posizioneIndividuale;
	}

	public void setPosizioneIndividuale(String posizioneIndividuale) {
		this.posizioneIndividuale = posizioneIndividuale;
	}

	public String getNumeroContratto() {
		return this.numeroContratto;
	}
	...
	public String getDataRicevimentoComunicazione() {
		return dataRicevimentoComunicazione;
	}

	public void setDataRicevimentoComunicazione(String dataRicevimentoComunicazione) {
		this.dataRicevimentoComunicazione = dataRicevimentoComunicazione;
	}
	...
	public String toString() {
		return "PraticheLegaliPignoramentoAE [istanteDenominazione=" + istanteDenominazione + ", istanteCodiceFiscale="
				...
				+ stato + ", prodotto=" + prodotto + ", codiceProdotto=" + codiceProdotto + ", numeroPolizza="
				+ numeroPolizza + ", beneficiariMorte=" + beneficiariMorte + ", tipologiaPolizza=" + tipologiaPolizza
				+ ", controvalore=" + controvalore + ", ultimoNav=" + ultimoNav + ", polizzaAScadenza="
				+ polizzaAScadenza + ", ramoI=" + ramoI + ", hasProposta=" + hasProposta + ", codiceIscritto="
				+ codiceIscritto + ", contributiLordi=" + contributiLordi + ", dataRiferimentoNav=" + dataRiferimentoNav
				+ ", dataAdesione=" + dataAdesione + ", posizioneIndividuale=" + posizioneIndividuale
				+ ", numeroContratto=" + numeroContratto + ", dataRicevimentoComunicazione="
				+ dataRicevimentoComunicazione + ", rivalutazioneAnnua=" + rivalutazioneAnnua
				+ ", capitaleAssicuratoRivalutato=" + capitaleAssicuratoRivalutato + ", emailProponente="
				+ emailProponente + "]";
	}
}
