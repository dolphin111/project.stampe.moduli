...
import com.fideuram.crm.stampe.model.PraticheLegaliPignoramentoAE;
...
public class LetteraPraticheLegaliPignoramentoAE extends LetteraEngine {

	private PraticheLegaliPignoramentoAE pratica;
	private String formatoData = "dd/MM/yyyy";
	private Return datiSintetici;
	private NumberFormat nf;

	public LetteraPraticheLegaliPignoramentoAE(int comID) throws WebServiceClientException {
		super(comID);
	}
	 ...
	 *
	 *             <p>
	 *             Estrazione dati e valorizzazione variabili del template lettera
	 *             legale Pignoramento AE
	 * 
	 */
	public void completaPolizza(Polizza dest, DomandaVO dom, ComunicazioneVO com) {

		pratica = new PraticheLegaliPignoramentoAE();
		...
		try {
			...
			XMLGregorianCalendar dataRicevimentoComunicazione = null;
			Calendar calendar = null;
			if (comunicazione != null) {
				dataRicevimentoComunicazione = comunicazione.getDataCreazione();
				if (dataRicevimentoComunicazione != null) {
					calendar = dataRicevimentoComunicazione.toGregorianCalendar();
				}
			}
			...
			pratica.setDataRicevimentoComunicazione(
					calendar != null ? new SimpleDateFormat(formatoData).format(calendar.getTime()) : "n.d.");
		...
		dest.setPraticheLegaliPignoramentoAE(pratica);
	}
