 ...
 */
public class D952ScadenzaPeriodica extends DomandaBase implements IDomanda{
    public D952ScadenzaPeriodica(int comID) {
        super(comID);
    }
    ...
    public void configuraPolizza(Polizza p) throws DaoException {
        try {
            p.setScadenza((Scadenza) new PucDao(comID).getScadenzaPeriodica(Long.decode(p.getNumero())));
