 ...
 * Time: 18.54
 */
public class FromPremium2FacileEd5 extends MockBase001 {
    ...
    public static void main(String args[]){
        ...
        try {
            Streamer.saveToFile(PdfFactory.getPdfFromOdt(facadeTrasformazioni.elaboraTrasformazioneCanaleFV(FromPremium2FacileEd5.getMock("U", 121), 807)), CrmProperties.getProperty("crm.services.temp.path"), "FromPremium_2_FacileED072016.pdf");
