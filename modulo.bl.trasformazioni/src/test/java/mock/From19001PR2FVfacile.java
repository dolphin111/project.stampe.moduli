 ...
 * Time: 10.20
 */
public class From19001PR2FVfacile extends MockBase19PR {
    ...
    public static void main(String args[]){
        ...
        try {
             Streamer.saveToFile(PdfFactory.getPdfFromOdt(facadeTrasformazioni.elaboraTrasformazioneCanaleFV(From19001PR2FVfacile.getMock(), 802)), CrmProperties.getProperty("crm.services.temp.path"), "FvFacile19001PR.pdf");
