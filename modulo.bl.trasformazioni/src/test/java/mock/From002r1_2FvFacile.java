 ...
 * Time: 16.40
 */
public class From002r1_2FvFacile extends MockBase001 {
    ...
    public static void main(String args[]){
        ...
        try {
            //Streamer.saveToFile(facadeTrasformazioni.elaboraTrasformazioneCanaleFV(From002r1_2FvFacile.getMock("R"), 802), CrmProperties.getProperty("crm.services.temp.path"), "FvFacile002PRed012009.odt");
            Streamer.saveToFile(PdfFactory.getPdfFromOdt(facadeTrasformazioni.elaboraTrasformazioneCanaleFV(From002r1_2FvFacile.getMock("R"), 802)), CrmProperties.getProperty("crm.services.temp.path"), "From002PRed012009_FvFacile.pdf");
            //Streamer.saveToFile(facadeTrasformazioni.elaboraTrasformazioneCanaleFV(From002r1_2FvFacile.getMock("U"), 802), CrmProperties.getProperty("crm.services.temp.path"), "FvFacile002PUed012009.odt");
            Streamer.saveToFile(PdfFactory.getPdfFromOdt(facadeTrasformazioni.elaboraTrasformazioneCanaleFV(From002r1_2FvFacile.getMock("U"), 802)), CrmProperties.getProperty("crm.services.temp.path"), "From002PUed012009_FvFacile.pdf");
