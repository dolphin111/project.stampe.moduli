 ...
 */
public class From002r2_2FvPremium extends MockBase001 {
    ...
    public static void main(String args[]){
        ...
        try {
            Streamer.saveToFile(PdfFactory.getPdfFromOdt(facadeTrasformazioni.elaboraTrasformazioneCanaleFV(From002r2_2FvPremium.getMock("R"), 803)), CrmProperties.getProperty("crm.services.temp.path"), "From002PRed012010_FvPremium.pdf");
            Streamer.saveToFile(PdfFactory.getPdfFromOdt(facadeTrasformazioni.elaboraTrasformazioneCanaleFV(From002r2_2FvPremium.getMock("U"), 803)), CrmProperties.getProperty("crm.services.temp.path"), "From002PUed012010_FvPremium.pdf");
