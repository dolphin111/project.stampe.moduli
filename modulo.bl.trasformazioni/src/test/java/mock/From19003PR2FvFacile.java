 ...
 * Time: 16.05
 */
public class From19003PR2FvFacile extends MockBase19PR {
    ...
    public static void main(String args[]){
        ...
        try {
            Streamer.saveToFile(PdfFactory.getPdfFromOdt(facadeTrasformazioni.elaboraTrasformazioneCanaleFV(From19003PR2FvFacile.getMock(), 802)), CrmProperties.getProperty("crm.services.temp.path"), "FvFacile19003PR.pdf");
