 ...
 * Time: 14.50
 */
public class From19002PR2FvPremium extends MockBase19PR {
    public static PolizzaTrasformabile getMock() throws ParseException, TrasformazioneException {
        ...
        polizzaTrasformabile.setOrigine(ContrattoOrigineFactory.getContratto(polizzaTrasformabile.getPolizza(), 19002));
    ...
    public static void main(String args[]){
        ...
        try {
            Streamer.saveToFile(PdfFactory.getPdfFromOdt(facadeTrasformazioni.elaboraTrasformazioneCanaleFV(From19002PR2FvPremium.getMock(), 803)), CrmProperties.getProperty("crm.services.temp.path"), "FvPremium19002PR.pdf");
