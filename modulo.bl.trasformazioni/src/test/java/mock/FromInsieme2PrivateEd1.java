 ...
 * Time: 18.54
 */
public class FromInsieme2PrivateEd1 extends MockBase001 {
    ...
    public static void main(String args[]){
        ...
        try {
            Streamer.saveToFile(PdfFactory.getPdfFromOdt(facadeTrasformazioni.elaboraTrasformazioneCanaleFV(FromInsieme2PrivateEd1.getMock("R", 113), 805)), CrmProperties.getProperty("crm.services.temp.path"), "TrasformabileInsieme2PrivateEd042011.pdf");
