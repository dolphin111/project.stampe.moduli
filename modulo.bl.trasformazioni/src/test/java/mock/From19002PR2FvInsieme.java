 ...
 * Time: 9.04
 */
public class From19002PR2FvInsieme extends MockBase19PR {
    ...
    public static void main(String args[]){
        ...
        try {
            Streamer.saveToFile(PdfFactory.getPdfFromOdt(facadeTrasformazioni.elaboraTrasformazioneCanaleFV(From19002PR2FvInsieme.getMock(), 801)), CrmProperties.getProperty("crm.services.temp.path"), "FvInsieme19002PR.pdf");
