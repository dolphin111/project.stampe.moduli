 ...
 * Time: 18.54
 */
public class FromInsieme2PrivateEd3 extends MockBase001 {
    ...
    public static void main(String args[]){
        ...
        try {
            Streamer.saveToFile(PdfFactory.getPdfFromOdt(facadeTrasformazioni.elaboraTrasformazioneCanaleFV(FromInsieme2PrivateEd3.getMock("U", 115), 805)), CrmProperties.getProperty("crm.services.temp.path"), "TrasformabileInsieme2PrivateEd0022013.pdf");
