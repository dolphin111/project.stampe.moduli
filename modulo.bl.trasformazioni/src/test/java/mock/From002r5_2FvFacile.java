 ...
 * Time: 10.23
 */
public class From002r5_2FvFacile extends MockBase001 {
    ...
    public static void main(String args[]){
        ...
        try {
            Streamer.saveToFile(PdfFactory.getPdfFromOdt(facadeTrasformazioni.elaboraTrasformazioneCanaleFV(From002r5_2FvFacile.getMock("U"), 802)), CrmProperties.getProperty("crm.services.temp.path"), "From002PUed012012_FvFacile.pdf");
