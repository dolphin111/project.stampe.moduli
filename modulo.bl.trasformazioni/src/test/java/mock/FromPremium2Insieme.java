 ...
 * Time: 18.54
 */
public class FromPremium2Insieme extends MockBase001 {
    ...
    public static void main(String args[]){
        ...
        try {
            Streamer.saveToFile(PdfFactory.getPdfFromOdt(facadeTrasformazioni.elaboraTrasformazioneCanaleFV(FromPremium2Insieme.getMock("U", 117), 806)), CrmProperties.getProperty("crm.services.temp.path"), "FromPremium_2_InsiemeED112011.pdf");
