 ...
 */
public class From002r2_2FvFacile extends MockBase001 {
    ...
    public static void main(String args[]){
        ...
        try {
            Streamer.saveToFile(PdfFactory.getPdfFromOdt(facadeTrasformazioni.elaboraTrasformazioneCanaleFV(From002r2_2FvFacile.getMock("R"), 802)), CrmProperties.getProperty("crm.services.temp.path"), "From002PRed012010_FvFacile.pdf");
            Streamer.saveToFile(PdfFactory.getPdfFromOdt(facadeTrasformazioni.elaboraTrasformazioneCanaleFV(From002r2_2FvFacile.getMock("U"), 802)), CrmProperties.getProperty("crm.services.temp.path"), "From002PUed012010_FvFacile.pdf");
