 ...
 * Time: 12.39
 */
public class From35006PU2FvInsieme extends MockBasePU {
    ...
    public static PolizzaTrasformabile getMock() throws ParseException, TrasformazioneException {
        ...
        polizzaTrasformabile.setOrigine(ContrattoOrigineFactory.getContratto(polizzaTrasformabile.getPolizza(), 35006));
