 ...
 * Time: 18.54
 */
public class FromPremium2InsiemeEd4 extends MockBase001 {
    ...
    public static void main(String args[]){
        ...
        try {
            Streamer.saveToFile(PdfFactory.getPdfFromOdt(facadeTrasformazioni.elaboraTrasformazioneCanaleFV(FromPremium2InsiemeEd4.getMock("U", 120), 806)), CrmProperties.getProperty("crm.services.temp.path"), "FromPremium_2_InsiemeED072014_032016.pdf");
