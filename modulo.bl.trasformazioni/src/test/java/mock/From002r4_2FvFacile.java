 ...
 * Time: 10.38
 */
public class From002r4_2FvFacile  extends MockBase001 {
    ...
    public static void main(String args[]){
        ...
        try {
            Streamer.saveToFile(PdfFactory.getPdfFromOdt(facadeTrasformazioni.elaboraTrasformazioneCanaleFV(From002r4_2FvFacile.getMock("U"), 802)), CrmProperties.getProperty("crm.services.temp.path"), "From002PUed012011_FvFacile.pdf");
