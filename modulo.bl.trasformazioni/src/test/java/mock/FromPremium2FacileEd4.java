 ...
 * Time: 18.54
 */
public class FromPremium2FacileEd4 extends MockBase001 {
    ...
    public static void main(String args[]){
        ...
        try {
            Streamer.saveToFile(PdfFactory.getPdfFromOdt(facadeTrasformazioni.elaboraTrasformazioneCanaleFV(FromPremium2FacileEd4.getMock("U", 120), 807)), CrmProperties.getProperty("crm.services.temp.path"), "FromPremium_2_FacileED072014_032016.pdf");
