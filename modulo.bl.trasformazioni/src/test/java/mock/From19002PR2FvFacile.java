 ...
 * Time: 14.50
 */
public class From19002PR2FvFacile extends MockBase19PR {
    ...
    public static void main(String args[]){
        ...
        try {
            Streamer.saveToFile(PdfFactory.getPdfFromOdt(facadeTrasformazioni.elaboraTrasformazioneCanaleFV(From19002PR2FvFacile.getMock(), 802)), CrmProperties.getProperty("crm.services.temp.path"), "FvFacile19002PR.pdf");
