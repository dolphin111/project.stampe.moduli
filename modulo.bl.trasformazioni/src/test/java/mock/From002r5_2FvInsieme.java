 ...
 * Time: 18.29
 */
public class From002r5_2FvInsieme extends MockBase001 {
    ...
    public static void main(String args[]){
        ...
        try {
            Streamer.saveToFile(PdfFactory.getPdfFromOdt(facadeTrasformazioni.elaboraTrasformazioneCanaleFV(From002r5_2FvInsieme.getMock("U"), 801)), CrmProperties.getProperty("crm.services.temp.path"), "From002PUed012012FvInsieme.pdf");
