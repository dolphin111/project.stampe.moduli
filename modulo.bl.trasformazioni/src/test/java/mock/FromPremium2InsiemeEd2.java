 ...
 * Time: 18.54
 */
public class FromPremium2InsiemeEd2 extends MockBase001 {
    ...
    public static void main(String args[]){
        ...
        try {
            Streamer.saveToFile(PdfFactory.getPdfFromOdt(facadeTrasformazioni.elaboraTrasformazioneCanaleFV(FromPremium2InsiemeEd2.getMock("U", 118), 806)), CrmProperties.getProperty("crm.services.temp.path"), "FromPremium_2_InsiemeED032012.pdf");
