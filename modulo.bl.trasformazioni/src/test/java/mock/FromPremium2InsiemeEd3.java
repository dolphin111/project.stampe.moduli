 ...
 * Time: 18.54
 */
public class FromPremium2InsiemeEd3 extends MockBase001 {
    ...
    public static void main(String args[]){
        ...
        try {
            Streamer.saveToFile(PdfFactory.getPdfFromOdt(facadeTrasformazioni.elaboraTrasformazioneCanaleFV(FromPremium2InsiemeEd3.getMock("U", 119), 806)), CrmProperties.getProperty("crm.services.temp.path"), "FromPremium_2_InsiemeED072012.pdf");
