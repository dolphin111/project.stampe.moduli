...
public class Contratto {
    ...
    private String        tipoLiquidazione;   //tipo liquidazione
    ...
    public boolean hasCd(){
        if(null==compagniaDiDestinazione)
          return false;
        else if(null==compagniaDiDestinazione.getRagioneSociale() || compagniaDiDestinazione.getRagioneSociale().trim().equals(""))
          return false;
        else
          return true;
    }
	...
	public void setTipoLiquidazione(String tipoLiquidazione) {
