 ...
 * Time: 15.42
 */
public class TrasferimentoInIngressoSenzaSeguitoTest {
    public static void main(String args[]) throws Exception {
        ...
        byte[] b= (byte[]) new ControllerActionsGenerics().elaboraProcesso(anomalia(),1005);
        StreamerFactory.saveFile(b, CrmProperties.getProperty("crm.services.temp.path"), "PrevidenzaTrasferimentoIngressoSenzaSollecito.odt");
    }
