...
public class RifiutoBTest {
	
	 public static void main(String args[]){
         new RifiutoBTest().test(1122);
     }
     ...
     private static String getXmlAnomalia(){
         ...
         /*String xml = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"
         		...
         		+ "<dataAnticipazioneFondoPensioneFideuram>2016-09-29T10:02:17.456+01:00</dataAnticipazioneFondoPensioneFideuram>"
         		+ "<polizza>"
         		+ "	<fondoPensione>"
