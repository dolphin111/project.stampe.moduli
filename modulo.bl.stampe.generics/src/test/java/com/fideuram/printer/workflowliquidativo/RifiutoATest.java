...
public class RifiutoATest {

	 public static void main(String args[]){
         new RifiutoATest().test(1121);
     }
     ...
     public void test(int richiesta){
         try {
             ...
             byte[] b= (byte[])  new ControllerActionsGenerics().elaboraProcesso(getXml(), richiesta);
     ...
     private static String getXml(){
         ...
         /*String xml = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"
         		...
         		+ "<polizza>"
         		+ "<fondoPensione><denominazione>Fondo Pensione Fideuram</denominazione></fondoPensione>"
        		+ "<compagniaDiDestinazione>"
        		+ "<titolo>Spett.le</titolo>"
        		+ "<ragioneSociale>ARCA PREVIDENZA - FONDO PENSIONE APERTO</ragioneSociale>"
        		+ "<indirizzo><via>Via Disciplini 3</via><cap>20123</cap><comune>MILANO</comune><provincia>MI</provincia><tel_fax></tel_fax><eMail></eMail></indirizzo>"
        		+ "</compagniaDiDestinazione>"
         		+ "<numeroID>70004951406</numeroID><assicurato><titolo>Gentile Signor</titolo><cognome>MONDINI</cognome><nome>PIETRO MASSIMO</nome><cf>MNDPRM82D04D150P</cf><indirizzo><via>PZZA ROMA 7</via><cap>26100</cap><comune>CREMONA</comune><provincia>CR</provincia><tel_fax></tel_fax><eMail></eMail></indirizzo><dataNascita>1982-04-04T00:00:00+02:00</dataNascita><sesso>M</sesso></assicurato><aderente><titolo>Gentile Signor</titolo><cognome>MONDINI</cognome><nome>PIETRO MASSIMO</nome><cf>MNDPRM82D04D150P</cf><indirizzo><via>PZZA ROMA 7</via><cap>26100</cap><comune>CREMONA</comune><provincia>CR</provincia><tel_fax></tel_fax><eMail></eMail></indirizzo><dataNascita>1982-04-04T00:00:00+02:00</dataNascita><sesso>M</sesso></aderente>"
         		+ "<pb><titolo>Gentile Signor</titolo><cognome>SOSSI</cognome><nome>DIEGO</nome><cf>SSSDGI72M12D150Q</cf><indirizzo><via>VIA DANTE, 104/A                                  </via><cap>26100</cap><comune>CREMONA                  </comune><provincia>CR</provincia><tel_fax></tel_fax><eMail></eMail></indirizzo><dataNascita>1972-08-12T00:00:00+01:00</dataNascita><sesso>M</sesso></pb>"
         		+ "</polizza></RifiutoWFL>";*/
         		
         		
    	 String xml = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?> "
    	 		+ "<RifiutoWFL>"
     	 		+ "<iscrizioneFPA>2013-02-18T00:00:00+01:00</iscrizioneFPA>"
     	 		+ "<dataTrasferimento>2015-02-18T00:00:00+01:00</dataTrasferimento>"
     	 		+ "<descrizioneFondo>Fondo Pensione Fideuram</descrizioneFondo>"
    	 		+ "<codiceCOVIP>5037</codiceCOVIP>"
    	 		+ "<dataRichiesta>2016-11-17T15:07:54.150+01:00</dataRichiesta>"
    	 		+ "<polizza>"
    	 		+ "	<fondoPensione>"
