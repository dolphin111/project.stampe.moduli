...
import com.fideuram.crm.stampe.engine.processi.ripensamentoRendita.SollecitoDocumentiRipensamentoRendita;
...
public class ControllerAction {
    ...
    private Object getDocumento(String data, int richiesta, int formato) throws DocGeneratorException {
        ...
        LoggingUtils.info("DATI IN INGRESSO: " + data);
        ...
        try{
            switch (richiesta) {
                ...
                case(15)://DECUMULO
                    pb = new Decumulo();
                    return pb.getDocumento(data, richiesta, formato);
                case(21)://SOLLECITO DOCUMENTI RIPENSAMENTO RENDITA
                    pb = new SollecitoDocumentiRipensamentoRendita();
                    return pb.getDocumento(data, richiesta, formato);
                ...
                //todo chiamare il generatore odt o tagliare     return new FacadeCredenziali().stampa(data,richiesta);
                 ...
                 case 1005: //Previdenza: Richiesta Trasferimento in ingresso SENZA SEGUITO
                 ...
                 case 1120: //PREVIDENZA MODULO 20   //PRIMA RICHIESTA DOCUMENTI
                 ...
                 case 20: //simulatore multicomparto FPA
