 ...
 * Time: 12.38
 */
public class PreventivoStampabilePlus extends Preventivo{

	private static final long serialVersionUID = -708869475896069751L;
	...
	private Boolean consensoCCSG; //    consenso comunicazioni societa' del gruppo
    private Boolean consensoCMI;  //    consenso marketing interno
    private Boolean consensoCDP;  //    consenso dati particolari
