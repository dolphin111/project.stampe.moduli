...
import com.fideuram.preventivo.modello.*;
...
public class TestGemini {
    ...
    public static void main(String args[]) throws Exception, URISyntaxException {
        ...
        stream =  new FacadePreventivi().getDocumento(preventivo,"112");
...
*/
    ...
    private static Preventivo mockB(){
        Preventivo preventivo = new Preventivo();
...
*/
        ...
        premi.setPremioUnico("69988.25");
        premi.setQuotaGestioneSeparata(5000.00);
        premi.setPercentualePremioGS(2.50);
        premi.setSviluppoPerAnni(3);
        premi.setCarTot(0.5);
        ...
        List<Double> listCapitaleAssicuratoPerAnno = new ArrayList<Double>();
        listCapitaleAssicuratoPerAnno.add(1121231213.01);
        listCapitaleAssicuratoPerAnno.add(1221312312312312332.02);
        listCapitaleAssicuratoPerAnno.add(11231231231223123123123123.03);

        List<Double> listCapitaleAssicuratoCasoMortePerAnnoA = new ArrayList<Double>();
        listCapitaleAssicuratoCasoMortePerAnnoA.add(211221.01);
        listCapitaleAssicuratoCasoMortePerAnnoA.add(2311231233122.02);
        listCapitaleAssicuratoCasoMortePerAnnoA.add(22222222.03);

        List<Double> listCapitaleAssicuratoCasoMortePerAnnoB = new ArrayList<Double>();
        listCapitaleAssicuratoCasoMortePerAnnoB.add(123121231231233123123.01);
        listCapitaleAssicuratoCasoMortePerAnnoB.add(1231212312312213.02);
        listCapitaleAssicuratoCasoMortePerAnnoB.add(123123123123123123123133.03);
        ...
        capitale.setValoriRiscattoFineAnnoA( listValoriRiscattoFineAnnoA );
        capitale.setValoriRiscattoFineAnnoB( listValoriRiscattoFineAnnoB );
        capitale.setCapitaleAssicurato("1456654.6876");
        ...
        preventivo.setComm(1.50);
        preventivo.setRmg(0.00);
        preventivo.setRla(5.20);
        preventivo.setRlb(5.10);
        preventivo.setRna(2.6);
        preventivo.setRnb(6.6);
