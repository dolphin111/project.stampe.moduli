 ...
 * Time: 15.48
 */
public class TestTcmEvolutaBozza {
...
//        consensi
        preventivo.setConsensoCCSG(true);
        preventivo.setConsensoCMI(false);
        
        byte[] stream = null;


            stream =  new FacadePreventivi().getDocumento(preventivo,"115");
            //System.out.println(i + " - " + stream);
            System.out.println(" - " + stream);
            Streamer.saveToFile(stream, CrmProperties.getProperty("crm.services.temp.path"), "preventivoBozza.pdf");
