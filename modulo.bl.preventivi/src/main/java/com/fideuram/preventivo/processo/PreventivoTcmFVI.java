 ...
 * Time: 14.45
 */
public class PreventivoTcmFVI {

    public Object getDocumento(PreventivoFVI p, int richiesta)
            throws DocGeneratorException
    {
        LoggingUtils.debug("com.fideuram.crm.stampe.engine.processi.preventivi.LetteraPreventiviTCMFVI.getDocumento");
        ...
        try{
            ...
            try {
                ...
                LoggingUtils.error("LetteraPreventiviTCMFVI.getDocumento "+e.getMessage());
                e.printStackTrace();
            ...
            */
            ...
            if(preventivoStampabile.getBozza()){
            	...
            	return generatoreOdt(map, Templates.TEMPLATE_BOZZE_TCM_FVI);
            }else{
            	...
            	if(preventivoStampabile.getBozza()){
            		...
            		return generatoreOdt(map, Templates.TEMPLATE_TCM_FVI);
            	}
