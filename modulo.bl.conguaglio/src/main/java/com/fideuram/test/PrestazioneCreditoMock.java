...
public class PrestazioneCreditoMock {
    ...
    public static Prestazione getMock(){
        ...
        c.setProvincia(("AR"));
        c.setDataVersamento("29-12-2015");
        c.setCodiceIban("IT02B0103025401000000189826");
        c.setPagamentoIntestato("Fierli Fausto");
        c.setCodiceFiscale("PGHFHFJJFJFJFJJF");
        c.setImportoDiConguaglio("252,79");
        return c;
    }
       ...
       public static void main(String args[]) throws JAXBException, IOException {
        ...
        for(int i=0;i<1;i++){
            ...
            XmlWriter.scriviStoXml(xml,c.getNumeroPolizze().trim()+ ".xml", "C:\\progetti\\stampe\\config\\prestazioni\\credito");
    ...
    public static void main1(String args[]) throws JAXBException, IOException {
          ...
          String xml="";
          //  Prestazioni prestazioni = (Prestazioni) Converter.xml2Object(new Prestazioni(), xml);
